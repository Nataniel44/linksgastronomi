                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <div className="flex gap-3">
                      <button
                        ...
                        className={`flex-1 py-3 rounded-full font-bold transition-all text-sm sm:text-base ${formData.paymentMethod === 'efectivo'
                          ? 'bg-yellow-500 text-white shadow-lg'
                          : 'bg-white border border-yellow-400 text-yellow-600 hover:bg-yellow-50'
                          }`}
                      >
                      ...
                      <button
                        ...
                        className={`flex-1 py-3 rounded-full font-bold transition-all text-sm sm:text-base ${formData.paymentMethod === 'transferencia'
                          ? 'bg-yellow-500 text-white shadow-lg'
                          : 'bg-white border border-yellow-400 text-yellow-600 hover:bg-yellow-50'
                          }`}
                      >
