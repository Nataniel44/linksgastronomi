...
const baseClasses = "font-bold px-8 py-4 rounded-full shadow-xl text-base transition-transform hover:scale-105 border-2 flex items-center gap-2 justify-center";
