...
✅ *TOTAL: $${total}*`;
    ...
    const handleViewStatus = () => setShowTracker(true);
    ...
    return (
        <>
            ...
            {/* Sidebar */}
            <div className="fixed inset-y-0 right-0 z-50 w-full max-w-md bg-gray-900 text-white p-6 flex flex-col rounded-l-2xl shadow-2xl overflow-hidden transition-transform translate-x-0">
                {!orderSuccess ? (
                    <>
                        <button
                            onClick={onClose}
