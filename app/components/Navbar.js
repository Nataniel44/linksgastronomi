    ...
    <nav className={navClasses}>
      <div className="container mx-auto flex justify-center w-full items-center p-3">
        <div className="z-50  flex items-center w-full justify-between">
          ...
          <div className="md:hidden ">
            <button
              ...
              onClick={toggleMenu}
              className=" w-10 h-10 flex items-center dark:text-black text-white  justify-center bg-transparent focus:outline-none hover:bg-gray-200 dark:hover:bg-gray-200/65 rounded-md"
            >
              {isOpen ? (
                <svg
        ...
        <div className="hidden md:flex items-center gap-8 text-black">
          ...
          {/* Order Button */ }
          <button className="bg-yellow-500 hover:bg-yellow-600 text-black font-bold py-2 px-4 rounded-full flex items-center gap-2 transition duration-300">
            Hacer pedido
        ...
        <motion.div
          ...
          className={`fixed top-0 right-0 w-full h-screen md:hidden  flex flex-col justify-center items-center  z-40 bg-black/60`}
          variants={{
            open: {
              x: 0,
              opacity: 1,
